...
#     SetStartLocation(currentStage,CG, 2, cx2, cy2)
#     SetStartLocation(currentStage,CG, 1, cx3, cy3)

#     '''calculate distance, dis = sqrt((cx-newx)**2+(cy-y)**2)'''
#     distance = sqrt((cx2-headX)**2+(cy2-headY)**2)
