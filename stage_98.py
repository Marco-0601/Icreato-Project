...
#     cy2 += speed
#     cy3 += speed
#     SetStartLocation(currentStage,CG, 1, cx1, cy1)
#     SetStartLocation(currentStage,CG, 0, cx2, cy2)
#     SetStartLocation(currentStage,CG, 2, cx3, cy3)

#     '''calculate distance, dis = sqrt((cx-newx)**2+(cy-y)**2)'''
#     distance = sqrt((cx3-headX)**2+(cy3-headY)**2)
...
if timeIndex==1:    
    bottomBun = burger(11,4,[0,4,3,2,1])
